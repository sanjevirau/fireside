...
| --- | --- | ---: | ---: | ---: | ---: |
| memory | long-polling | 100 | 12.100 | 1500 | 1.254 |
| memory | streaming | 100 | 11.400 | 1000 | 1.135 |
| memory | buffering-proxy-auto-detection | 100 | 12.200 | 2000 | 1.300 |
| disk-wal | long-polling | 100 | 21.900 | 1500 | 1.461 |
| disk-wal | streaming | 100 | 19.300 | 1000 | 1.473 |
| disk-wal | buffering-proxy-auto-detection | 100 | 20.200 | 2000 | 1.262 |
...
- Browser: 152.0.7977.65
- Java: openjdk 26.0.2.1 2026-08-18; OpenJDK Runtime Environment Homebrew (build 26.0.2.1); OpenJDK 64-Bit Server VM Homebrew (build 26.0.2.1, mixed mode, sharing)
- Node: v24.20.0
