...
phase5_candidate=27e96b669c374c92483b20d28293992fb5ebb129
phase5_short=27e96b6
phase5_ci_run=33838985452
...
phase5_smoke="$phase5_root/diagnostics/two-tier-smoke-v3-20260904-$phase5_short-r35"
phase5_full="$phase5_root/full-gates/full-gate-v3-20260904-$phase5_short-r35"
...
phase5_launcher="$phase5_root/fireside-phase5-$phase5_short-r35-then-full.sh"
phase5_controller_log="$phase5_root/controller-$phase5_short-r35-then-full.log"
phase5_controller_exit="$phase5_root/controller-$phase5_short-r35-then-full.exit"
...
date --iso-8601=seconds
printf 'Starting r35 cheap smoke: official then Fireside\n'
set +e
