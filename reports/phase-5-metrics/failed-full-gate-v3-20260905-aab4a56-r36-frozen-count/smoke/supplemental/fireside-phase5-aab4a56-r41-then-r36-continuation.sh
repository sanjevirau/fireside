...
phase5_candidate=aab4a562455619092ed51d11b419580d902db67a
phase5_short=aab4a56
phase5_ci_run=33906402165
...
phase5_harness="$phase5_root/harness-$phase5_short-r41"
phase5_target="$phase5_root/target-$phase5_short-r41"
phase5_smoke="$phase5_root/diagnostics/two-tier-smoke-v3-20260905-$phase5_short-r41"
phase5_full="$phase5_root/full-gates/full-gate-v3-20260905-$phase5_short-r36-fireside-repair"
phase5_ci="$phase5_root/ci-$phase5_short-r41-seven-jobs.json"
phase5_build_log="$phase5_root/build-$phase5_short-r41.log"
phase5_build_exit="$phase5_root/build-$phase5_short-r41.exit"
phase5_build_sums="$phase5_root/build-$phase5_short-r41.SHA256SUMS"
phase5_launcher="$phase5_root/fireside-phase5-$phase5_short-r41-then-r36-continuation.sh"
phase5_controller_log="$phase5_root/controller-$phase5_short-r41-then-r36-continuation.log"
phase5_controller_exit="$phase5_root/controller-$phase5_short-r41-then-r36-continuation.exit"
...
date --iso-8601=seconds
printf 'Starting r41 exact-candidate cheap smoke: official then Fireside\n'
set +e
