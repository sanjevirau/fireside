...
phase5_candidate=48b4887f1cdb24438f14589cfdcfd99fe80ca53b
phase5_short=48b4887
phase5_ci_run=33877161699
...
phase5_harness="$phase5_root/harness-$phase5_short-r37"
phase5_target="$phase5_root/target-$phase5_short-r37"
phase5_smoke="$phase5_root/diagnostics/two-tier-smoke-v3-20260904-$phase5_short-r37"
phase5_full="$phase5_root/full-gates/full-gate-v3-20260904-$phase5_short-r36-fireside-repair"
phase5_ci="$phase5_root/ci-$phase5_short-r37-seven-jobs.json"
phase5_build_log="$phase5_root/build-$phase5_short-r37.log"
phase5_build_exit="$phase5_root/build-$phase5_short-r37.exit"
phase5_build_sums="$phase5_root/build-$phase5_short-r37.SHA256SUMS"
phase5_launcher="$phase5_root/fireside-phase5-$phase5_short-r37-then-r36-continuation.sh"
phase5_controller_log="$phase5_root/controller-$phase5_short-r37-then-r36-continuation.log"
phase5_controller_exit="$phase5_root/controller-$phase5_short-r37-then-r36-continuation.exit"
...
date --iso-8601=seconds
printf 'Starting r37 exact-candidate cheap smoke: official then Fireside\n'
set +e
