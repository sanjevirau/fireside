...
phase5_candidate=74113adf310d9beb6369cf4b1fe7da6471c8dc40
phase5_short=74113ad
phase5_ci_run=33834124800
phase5_root=/srv/dev-fast/runtime-data/fireside-phase5-20260902T1417+0800-5b51e4d
phase5_harness="$phase5_root/harness-$phase5_short"
phase5_target="$phase5_root/target-$phase5_short"
phase5_smoke="$phase5_root/diagnostics/two-tier-smoke-v3-20260904-$phase5_short-r34"
phase5_full="$phase5_root/full-gates/full-gate-v3-20260904-$phase5_short-r34"
phase5_ci="$phase5_root/ci-$phase5_short-seven-jobs.json"
phase5_build_log="$phase5_root/build-$phase5_short.log"
phase5_build_exit="$phase5_root/build-$phase5_short.exit"
phase5_build_sums="$phase5_root/build-$phase5_short.SHA256SUMS"
phase5_launcher="$phase5_root/fireside-phase5-$phase5_short-r34-then-full.sh"
phase5_controller_log="$phase5_root/controller-$phase5_short-r34-then-full.log"
phase5_controller_exit="$phase5_root/controller-$phase5_short-r34-then-full.exit"
...
set +e
{
  ...
  test "$(sha256sum "$phase5_harness/conformance/src/suite/run-phase5-browser-journeys.ts" | cut -d ' ' -f 1)" = ad61e2e6720abe5e53c745ec264c94166ccd3ff9662c84c1655062c9dd0258cc
  test "$(sha256sum "$phase5_harness/benchmarks/phase-5-twodart-acceptance.json" | cut -d ' ' -f 1)" = fe9d44c1edb6105d6edc9f0ab3b3251cb34929b7b6113e559ff9a2558ad7b957
  test -z "$(git -C "$phase5_harness" status --porcelain --untracked-files=no)"
  date --iso-8601=seconds
...
date --iso-8601=seconds
printf 'Starting r34 cheap smoke: official then Fireside\n'
set +e
