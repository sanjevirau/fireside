...
phase5_candidate=72a5c49442915076e4a0490864af5c67f2960044
phase5_short=72a5c49
phase5_ci_run=33826287482
...
phase5_smoke="$phase5_root/diagnostics/two-tier-smoke-v3-20260904-$phase5_short-r33"
phase5_full="$phase5_root/full-gates/full-gate-v3-20260904-$phase5_short-r33"
...
phase5_launcher="$phase5_root/fireside-phase5-$phase5_short-r33-then-full.sh"
...
date --iso-8601=seconds
printf 'Starting r33 cheap smoke: official then Fireside\n'
set +e
