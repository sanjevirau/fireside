...
phase5_candidate=585f588f5d6d420b057e472cfe08567b00e56d5a
phase5_short=585f588
phase5_ci_run=33822092710
...
phase5_smoke="$phase5_root/diagnostics/two-tier-smoke-v3-20260904-$phase5_short-r32"
phase5_full="$phase5_root/full-gates/full-gate-v3-20260904-$phase5_short-r32"
...
phase5_launcher="$phase5_root/fireside-phase5-$phase5_short-r32-then-full.sh"
...
date --iso-8601=seconds
printf 'Starting r32 cheap smoke: official then Fireside\n'
set +e
