...
phase5_candidate=f686f66ea431769548d17cb296c3bec316cab683
phase5_short=f686f66
phase5_ci_run=33886689214
...
phase5_harness="$phase5_root/harness-$phase5_short-r38"
phase5_target="$phase5_root/target-$phase5_short-r38"
phase5_smoke="$phase5_root/diagnostics/two-tier-smoke-v3-20260905-$phase5_short-r38"
phase5_full="$phase5_root/full-gates/full-gate-v3-20260905-$phase5_short-r36-fireside-repair"
phase5_ci="$phase5_root/ci-$phase5_short-r38-seven-jobs.json"
phase5_build_log="$phase5_root/build-$phase5_short-r38.log"
phase5_build_exit="$phase5_root/build-$phase5_short-r38.exit"
phase5_build_sums="$phase5_root/build-$phase5_short-r38.SHA256SUMS"
phase5_launcher="$phase5_root/fireside-phase5-$phase5_short-r38-then-r36-continuation.sh"
phase5_controller_log="$phase5_root/controller-$phase5_short-r38-then-r36-continuation.log"
phase5_controller_exit="$phase5_root/controller-$phase5_short-r38-then-r36-continuation.exit"
...
date --iso-8601=seconds
printf 'Starting r38 exact-candidate cheap smoke: official then Fireside\n'
set +e
