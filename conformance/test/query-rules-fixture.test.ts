...
const checksumManifests: Record<string, string> = {
  "1.21.0": "a516fb0200ed263a13b1e26762204233049e1f1833d368e29527aeb533434c1c",
  "1.22.0": "68de98af6b8be79174ef6c87fa2b6c7945e3c15b82bde853ec806e4045ccdd55",
};
...
test("both pinned official Java versions agree on every native query verdict", async () => {
...
for (const [version, jarHash] of Object.entries(jars)) {
  test(`official Java ${version} query-path oracle freezes wildcard and boolean-error semantics`, async () => {
    ...
    assert.equal(sha(manifest), version === "1.21.0"
      ? "2d5f219304c5632857601322a31218c082be012d02afe3e251ccda91167eecee"
      : "436c23a4c1152eb261aaab6b5bc8a4f3ab1138de07e60689609394281f7eff6f");
