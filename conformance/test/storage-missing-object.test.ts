    ...
    [
      ...
      { api: "firebase", kind: "media", status: 404, contentType: "text/plain; charset=utf-8", body: "Not Found" },
      {
        ...
        body: JSON.stringify({
          error: {
            code: 404,
            message: "No such object: synthetic-objects.example.test/samples/missing/picture.png",
            errors: [{
              message: "No such object: synthetic-objects.example.test/samples/missing/picture.png",
              domain: "global",
              reason: "notFound",
      ...
      },
      {
        ...
        body: "No such object: synthetic-objects.example.test/samples/missing/picture.png",
      },
    ],
  );
