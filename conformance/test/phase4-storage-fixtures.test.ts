...
interface Fixture {
  ...
  readonly syntheticRules?: Readonly<Record<string, string>>;
...
test("two independent synthetic Storage rules remain distinct and export/re-import is byte exact", async () => {
  const fixture = await load("storage-multi-bucket-rules-and-import-export");
  assertMetadata(fixture);
  assert.deepEqual(fixture.syntheticRules, {
    "demo-synthetic-app.appspot.com":
      "894555090e9871a813a1208a03004146c4eb6f0afbe7f610a09f7f15ebbc29ab",
    "synthetic-objects.example.test":
      "84a0db9dfc670c3b94fa3f7568a891410c6b148fb1cf28dbfca751522ab1cc2e",
  });
  ...
  assert.deepEqual(nestedValue(buckets.json, ["buckets"]), [
    { id: "demo-synthetic-app.appspot.com" },
    { id: "synthetic-objects.example.test" },
  ]);
