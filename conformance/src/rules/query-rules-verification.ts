...
const allowed = new Set([
  ...
  "owner-empty", "owner-nonmatching-extra-filter", "permission-get-allowed",
  "permission-in-all-granted", "short-circuit-missing-get", "array-contains-owner",
...
const owned = `projects/${queryRulesProject}/databases/(default)/documents/records/owned`;
