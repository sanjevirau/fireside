...
export const serializationCases = [
  ...
  { id: "wide-mixed-map", fields: {
    stringField: "value", stringArray: ["item-one"], label: "Synthetic record",
    objectWithEmptyArray: { tag: "plain", items: [] }, objectWithNull: { optional: null, values: ["first", "second"] },
    emptyObjectA: {}, emptyObjectB: {}, enabled: false,
    selectedA: "alpha", selectedB: "bravo", mode: "left",
    pair: { left: "one", right: "two" }, recentValues: [], _cachedValues: [],
    parentRef: null, revision: 1, count: 2, initial: 1,
  } },
] as const;
