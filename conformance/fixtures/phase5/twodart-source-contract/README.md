...
This fixture freezes the browser-visible routes, stable login selectors, local OTP API,
admin navigation inventory, and ordered acceptance journeys observed in the readable
Twodart source at the exact Phase 5 candidate revision.
