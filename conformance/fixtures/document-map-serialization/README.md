...
Independently captured on 2026-09-09 from pinned official Java emulators
1.21.0 and 1.22.0, using Java 26 and Node 24.20.0 locally. These are fresh
oracle recordings, not edited versions of earlier observations.
...
wide mixed-container document with domain-neutral fields. Exact decoded field JSON is retained, without volatile
...
The command runs from `conformance/`. Only isolated synthetic documents are used. Raw process logs are retained outside the fixture directory.
