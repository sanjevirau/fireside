...
> twenty-six checked-in backend and control conformance cases plus its dedicated
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Production cloud | pass (24/24; control N/A) | reference target | not implemented | not implemented | not implemented |
| Official Java emulator | pass (26/26) | comparison target; 7 known deviations | not run | not run | not run |
| fireside | pass (26/26 + strict 1/1) | current scope 26/26 + strict 1/1 | not implemented | not implemented | not implemented |
