...
> twenty-five checked-in backend and control conformance cases plus its dedicated
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Production cloud | pass (23/23; control N/A) | reference target | not implemented | not implemented | not implemented |
| Official Java emulator | pass (25/25) | comparison target; 7 known deviations | not run | not run | not run |
| fireside | pass (25/25 + strict 1/1) | current scope 25/25 + strict 1/1 | not implemented | not implemented | not implemented |
