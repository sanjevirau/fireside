...
> eleven checked-in backend conformance cases, but the remaining Phase 1 API,
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Production cloud | pass (11/11) | reference target | not implemented | not implemented | not implemented |
| Official Java emulator | pass (11/11) | comparison target; 1 known deviation | not run | not run | not run |
| fireside | pass (11/11) | current scope 11/11 | not implemented | not implemented | not implemented |
