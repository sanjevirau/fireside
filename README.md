...
> ten checked-in backend conformance cases, but the remaining Phase 1 API,
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Production cloud | pass (10/10) | reference target | not implemented | not implemented | not implemented |
| Official Java emulator | pass (10/10) | comparison target; 1 known deviation | not run | not run | not run |
| fireside | pass (10/10) | current scope 10/10 | not implemented | not implemented | not implemented |
