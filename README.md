...
> twenty-seven checked-in backend and control conformance cases plus its dedicated
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Production cloud | pass (25/25; control N/A) | reference target | not implemented | not implemented | not implemented |
| Official Java emulator | pass (27/27) | comparison target; 7 known deviations | not run | not run | not run |
| fireside | pass (27/27 + strict 1/1) | current scope 27/27 + strict 1/1 | not implemented | not implemented | not implemented |
